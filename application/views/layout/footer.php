...
<footer class="footer">
    <div class="w-100 clearfix">
        <span class="text-center text-sm-left d-md-inline-block">Park now - Um novo conceito em estacionamento</span>
        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Curso de codeigniter 3</span>
    </div>
</footer>

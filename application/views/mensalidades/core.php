                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (isset($mensalidade)) : ?>
                                ...
                                <p class="text-muted small mb-4"><i class="ik ik-calendar ik-2x">&nbsp;&nbsp;</i>Última atualização:&nbsp;&nbsp;</i><?php echo formata_data_banco_com_hora($mensalidade->mensalidade_data_alteracao); ?></p>

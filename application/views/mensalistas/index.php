                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-actions text-center">
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Editar" class="btn btn-icon btn-primary text-white" href="<?php echo base_url($this->router->fetch_class() . '/core/' . $mensalista->mensalista_id); ?>"><i class="ik ik-edit-2"></i></a>
